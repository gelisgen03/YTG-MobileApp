import 'dart:html';
import 'dart:io';
import 'package:food/girisEkrani.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //Aşağıdaki liste sayesinde 'body i her tıklamada degistiriyoruz'
  final List<Widget> Body_Control = [
    Center(
    ...
    Center(
      child: Duyurular_widget(), //6 //drawbar
    ),
    Center(
      child: Haberler_widget(), //7 //drawbar
    ),
    Center(
      child: Ezgi_widget(), //8 //drawbar
    ),
    Center(
      child: iletisim_widget(), //9 //drawbar
    ),
    Center(
      child: Text("Ayarlar"), //10 //drawbar
    ),
    Hakkinda_widget(), //11 //drawbar
    Center(
      child: Bildirimler_widget(), //12 //drawbar
    ),
  ];

  final List<Widget> AppBar_Control = [
    //AppBar her tıklamada degisimi için
    Center(
        child: Image.asset(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(child: AppBar_Control[state]),
      ),
      body: Body_Control[state],
      drawer: Drawer(
